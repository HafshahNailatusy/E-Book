...
function UsersSetting() {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:8000/user/getAll`, { withCredentials: true })
      .then((res) => {
        if (res.data != null) {
    ...
    return (
      <div className="usersColumn">
        <div className="usersInfo">
          <h3 className="usersInfoHeader">Admin</h3>
  ...
  const NormalUsers = () => {
    return (
      <div className="usersColumn">
        <div className="usersInfo">
          <h3 className="usersInfoHeader">Customers</h3>
          <span className="usersInfoText">
  ...
  const AddNewUserPopup = () => {
    ...
    const addNewUser = () => {
      axios
        .post(
          "http://localhost:8000/user/addByAdmin",
          {
            userDetails,
          },
          { withCredentials: true }
